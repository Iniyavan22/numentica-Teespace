...
const Blogs = () => {
    ...
    const handleClick = async (e:any) => {
        ...
        try {
            ...
            await account.create(generateRandomString(10), email, password);
            router.push('/login'); 
        } catch (error) {
    ...
    return (
        <div>
            <div className="flex items-center justify-center flex-col my-2 mx-48 w-[800px] text-center bg-login_bg border border-solid border-black rounded-xl">
                <p className="font-bold text-3xl my-8">Register</p>
                ...
                <form className="flex flex-col items-center justify-center py-6">
                    <div className="flex flex-col items-start">
                        ...
                        <input type="text" className="py-3 pl-2  rounded-md border border-solid border-black" placeholder="Username..."/>
                    </div>
                    <div className="flex flex-col items-start">
                        <label className="my-3 text-gray-500">Email</label>
                        <input type="email" className="py-3 pl-2  rounded-md border border-solid border-black" placeholder="Email..." value={email} onChange={(e) => setEmail(e.target.value)} />
                    </div>
                    <div className="flex flex-col items-start ">
                    ...
                    <button className="bg-green-600 py-3 w-56 rounded-xl text-white" type="submit" onClick={(e)=>handleClick(e)}>Register</button>
                </form>
            </div>
        </div>
    )
